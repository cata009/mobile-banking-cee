...
| Function | Description | User value | Status | Evidence |
| --- | --- | --- | --- | --- |
| Payments menu | Shows four primary payment actions, a horizontally scrollable QR/template/card repayment/exchange-rate shortcut rail with labels capped at 2 rows, and a New payment bottom sheet where Domestic opens a flow and Foreign/SEPA plus Templates/Beneficiaries remain placeholders | Gives the bottom-nav Payments tab a real stakeholder-demo surface | `implemented` | [`src/app/screens/payments/PaymentsScreen.tsx`](../../src/app/screens/payments/PaymentsScreen.tsx), [`src/app/components/payments/PaymentOtherShortcut.tsx`](../../src/app/components/payments/PaymentOtherShortcut.tsx), [`src/app/config/paymentsMenuConfig.ts`](../../src/app/config/paymentsMenuConfig.ts), [`src/app/components/BottomSheet.tsx`](../../src/app/components/BottomSheet.tsx), [`src/app/registry/screenRegistry.ts`](../../src/app/registry/screenRegistry.ts) |
...
| Products menu | Shows a draggable offers carousel with chevron-backed banners, fixed right image columns, clamped title/subtitle copy, reusable 164x120 product cards, and country-scoped Banking/ShopSmart tabs for RO/CZ/SK/HU only; `OTHER SOLUTIONS FOR YOU` / `Additional services` is limited to CZ/SK, RS/BA remain direct no-tab Products pages, and SI is cards-only with no offer rail/headings and no Insurance card; the banner component now supports reusable `family + normal/light` color variants through the Design System inventory | Gives the bottom-nav Products tab a real stakeholder-demo surface while preserving country differences | `implemented` | [`src/app/screens/products/ProductsScreen.tsx`](../../src/app/screens/products/ProductsScreen.tsx), [`src/app/components/products/ProductOfferCard.tsx`](../../src/app/components/products/ProductOfferCard.tsx), [`src/app/config/productBannerVariants.ts`](../../src/app/config/productBannerVariants.ts), [`src/app/components/products/ProductMenuCard.tsx`](../../src/app/components/products/ProductMenuCard.tsx), [`src/app/config/productsMenuConfig.ts`](../../src/app/config/productsMenuConfig.ts), [`src/app/registry/screenRegistry.ts`](../../src/app/registry/screenRegistry.ts) |
...
| More section | Country-specific tile grid plus logout modal, with Documents, Settings, and Contacts now opening real screens | Demonstrates service-discovery menu | `partial` | [`src/app/screens/more/MoreScreen.tsx`](../../src/app/screens/more/MoreScreen.tsx), [`src/app/config/moreCardsConfig.ts`](../../src/app/config/moreCardsConfig.ts), [`src/app/components/LogoutConfirmDialog.tsx`](../../src/app/components/LogoutConfirmDialog.tsx), [`src/app/screens/documents/DocumentsScreen.tsx`](../../src/app/screens/documents/DocumentsScreen.tsx), [`src/app/screens/settings/SettingsScreen.tsx`](../../src/app/screens/settings/SettingsScreen.tsx) |
