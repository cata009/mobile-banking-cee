...
- Platform maturity score: `48/100`
- Total verified capability areas: `20`
- Capability status counts:
  - `implemented`: 11
  - `partial`: 5
  - `mock-driven`: 4
  - `legacy/dormant`: 1
- Active page/state coverage mapped: `22/23` navigation states in the screen registry; `language-selector` remains a supporting component outside the registry
...
5. Mobile demo shell, design-system inventory, and the new contained RO Kids module are reusable foundations: the shell auto-fits inside the desktop viewport, icons/colors/templates are centralized for AI reuse, template entries now carry a typed component/screen/flow contract, and Mobile PI Kids has a Romania-only prototype for business/UX concept battles. Evidence: [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`scripts/audit-template-contract.mjs`](../../scripts/audit-template-contract.mjs), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts), [`src/app/screens/kids/RoKidsApp.tsx`](../../src/app/screens/kids/RoKidsApp.tsx), [`src/data/roKidsBanking.ts`](../../src/data/roKidsBanking.ts).
...
3. No product export, backend handoff, audit history, or approval workflows. A source-level AI catalog and template contract audit now exist for contributor/tooling use, but they are not a runtime product export or prompt-to-screen compiler. Evidence: [`src/app`](../../src/app), [`src/app/registry/aiCatalog.ts`](../../src/app/registry/aiCatalog.ts), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`scripts/audit-template-contract.mjs`](../../scripts/audit-template-contract.mjs), [`package.json`](../../package.json).
...
5. Export/handoff/output: there is no runtime product export or backend handoff. Output is the rendered on-screen demo state, plus a source-level AI catalog and typed template contract for future training/integration workflows. Evidence: [`package.json`](../../package.json), [`src/app`](../../src/app), [`src/app/registry/aiCatalog.ts`](../../src/app/registry/aiCatalog.ts), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`scripts/audit-template-contract.mjs`](../../scripts/audit-template-contract.mjs).
...
- Static data models feed the home summary, product accordions, transaction detail, mock Domestic payment drafts, and RO Kids local-state prototype. Evidence: [`src/data/products.ts`](../../src/data/products.ts), [`src/hooks/useProducts.tsx`](../../src/hooks/useProducts.tsx), [`src/app/config/productConfig.ts`](../../src/app/config/productConfig.ts), [`src/data/paymentFlow.ts`](../../src/data/paymentFlow.ts), [`src/data/roKidsBanking.ts`](../../src/data/roKidsBanking.ts).
...
| Mobile frame shell | Renders phone frame, status bar, dynamic island, overlays, glow, bounded desktop auto-fit scaling, and a demo-header icon-only screenshot dropdown after Settings / Control Panel for visible/full-height PNG export with L1 bottom navigation anchored at the bottom of full-height captures; the screenshot control is disabled in Design System Inventory | Creates a consistent device-like viewport without unwanted page-level desktop scroll and lets stakeholders export the current phone screen without bezel/chrome | `implemented` | [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/demo/DemoTopBar.tsx`](../../src/app/components/demo/DemoTopBar.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/demo/PhoneScreenshotControl.tsx`](../../src/app/components/demo/PhoneScreenshotControl.tsx), [`src/app/utils/phoneScreenshot.ts`](../../src/app/utils/phoneScreenshot.ts), [`src/app/components/StatusBar.tsx`](../../src/app/components/StatusBar.tsx), [`src/app/components/DynamicIsland.tsx`](../../src/app/components/DynamicIsland.tsx) |
...
| Navigation shell | Build + manual browser verification for mobile frame viewport fit, stable top-level header action slots across Home/Payments/Products/More, Messages header routing, and the demo-header screenshot control/dropdown including visible PNG download, Design System disabled state, and full-height L1 bottom-nav anchoring | no route-state, visual viewport, or screenshot-download regression tests | state-machine tests for screen transitions, back stack, desktop viewport fit at multiple heights, top-header action-slot stability, Messages entry/back navigation, and visible/full-height screenshot export with bottom-nav placement assertions | [`src/app/contexts/NavigationContext.tsx`](../../src/app/contexts/NavigationContext.tsx), [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/demo/DemoTopBar.tsx`](../../src/app/components/demo/DemoTopBar.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/demo/PhoneScreenshotControl.tsx`](../../src/app/components/demo/PhoneScreenshotControl.tsx), [`src/app/utils/phoneScreenshot.ts`](../../src/app/utils/phoneScreenshot.ts), [`src/app/components/HeaderActionIcons.tsx`](../../src/app/components/HeaderActionIcons.tsx), [`src/app/screens/messages/MessagesScreen.tsx`](../../src/app/screens/messages/MessagesScreen.tsx) |
...
| Design system | Theme tokens, generic ui files, active component inventory with selector-grouped multi-variant specimens, template registry with 50 code-backed previews and typed contract audit, centralized icon registry, centralized color registry, and Light/Dark smoke checks | no automated visual consistency, reconstructed-template visual, icon-registry, or color-token guard | component inventory, screenshot/code-template visual coverage, reconstructed-template visual coverage, icon registry audit, color-token audit, and Light/Dark visual snapshots | [`src/styles/theme.css`](../../src/styles/theme.css), [`src/app/components/ui`](../../src/app/components/ui), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`scripts/audit-template-contract.mjs`](../../scripts/audit-template-contract.mjs), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) |
