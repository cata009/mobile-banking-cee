...
5. Mobile demo shell, design-system inventory, and the new contained RO Kids module are reusable foundations: the shell auto-fits inside the desktop viewport, icons/colors/templates are centralized for AI reuse, and Mobile PI Kids now has a Romania-only prototype for business/UX concept battles. Evidence: [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts), [`src/app/screens/kids/RoKidsApp.tsx`](../../src/app/screens/kids/RoKidsApp.tsx), [`src/data/roKidsBanking.ts`](../../src/data/roKidsBanking.ts).
...
| Appearance selector | Switches the active demo between Light and Dark token themes, with exact-match dark partners reused from the approved reference DS table where the current DS contains the same light hex | Lets stakeholders inspect current DS colors in both appearance modes without changing product/design-system context | `implemented` | [`src/app/components/demo/DemoTopBar.tsx`](../../src/app/components/demo/DemoTopBar.tsx), [`src/app/components/demo/DemoFeatureSidePanel.tsx`](../../src/app/components/demo/DemoFeatureSidePanel.tsx), [`src/app/state/demoStore.tsx`](../../src/app/state/demoStore.tsx), [`src/styles/theme.css`](../../src/styles/theme.css), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) |
...
| Design-system inventory | `AI/DS foundation` | `implemented` | `medium` | `critical` | component/template/icon/color registries plus 50 code-backed template previews: 30 screenshot-backed and 20 code-only active-pattern templates; active icons route through `AppIcon`, with redundant lucide wrappers removed and remaining lucide-alone glyphs centralized | [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) | No automated registry drift audits yet |
...
| Screenshot/code templates | `templateRegistry.ts`, `screenshots/` assets, 30 reconstructed screenshot-backed previews, and 20 code-only active-pattern previews | Design System Inventory `Templates` tab | static TS source files, image files where present, and JSX preview components | build plus registry coverage check and browser smoke | `medium` | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`screenshots`](../../screenshots), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
| Design System templates | Template registry plus screenshot assets, 30 screenshot-backed code previews, and 20 code-only active-pattern previews | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`screenshots`](../../screenshots) | AI/component reuse mapping can drift without automated reconstructed-template audits | [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
| Screenshot template catalog | `templateRegistry.ts` entries backed by files in `screenshots/`, 30 screenshot-backed reconstructed JSX previews, and 20 code-only active-pattern previews | `persistent source artifact` | code preview UI plus source comparison where an image exists | no runtime export | git versioned | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`screenshots`](../../screenshots), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
5. Screenshot/code template inventory for AI/component reuse review, with 50 real code previews: all 30 screenshot-backed templates plus 20 code-only active-pattern templates. Evidence: [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`screenshots`](../../screenshots).
...
| Payments/Products menus and Domestic payment flow | Build + Chrome/headless/in-app browser smoke verification for bottom-nav entry, Payments `OTHER` shortcut SVG/label computed style contract, New payment sheet open/close, New payment action row and Discover banner SVG/typography/spacing contracts, CZ domestic subtitle, Domestic create/review/sign/success, Transaction Detail -> Redo payment, Products country tab rule, Products offer-card computed style contract, Products offer carousel drag/snap, Products `16px` spacing rhythm, and Products card computed style contract | no component, state-machine, or visual regression coverage | tests for Payments action presence, Payments `OTHER` shortcut SVG slots and label typography, New payment bottom sheet content/close behavior, New payment action row 80px/no-gap contract, Discover banner icon and typography contract, New payment -> Domestic blank form, Transaction Detail -> Redo prefill, Products RO/CZ/SK/HU ShopSmart visibility, non-tab countries hiding ShopSmart, Products offer-card sizing/typography/drag/snap/spacing, and Products card sizing/typography | [`src/app/screens/payments/PaymentsScreen.tsx`](../../src/app/screens/payments/PaymentsScreen.tsx), [`src/app/components/payments/PaymentOtherShortcut.tsx`](../../src/app/components/payments/PaymentOtherShortcut.tsx), [`src/app/components/payments/NewPaymentActionListItem.tsx`](../../src/app/components/payments/NewPaymentActionListItem.tsx), [`src/app/components/payments/NewPaymentDiscoverBanner.tsx`](../../src/app/components/payments/NewPaymentDiscoverBanner.tsx), [`src/app/components/BottomSheet.tsx`](../../src/app/components/BottomSheet.tsx), [`src/app/screens/payments/DomesticPaymentFlowScreens.tsx`](../../src/app/screens/payments/DomesticPaymentFlowScreens.tsx), [`src/data/paymentFlow.ts`](../../src/data/paymentFlow.ts), [`src/app/screens/products/ProductsScreen.tsx`](../../src/app/screens/products/ProductsScreen.tsx), [`src/app/components/products/ProductOfferCard.tsx`](../../src/app/components/products/ProductOfferCard.tsx), [`src/app/components/products/ProductMenuCard.tsx`](../../src/app/components/products/ProductMenuCard.tsx), [`src/app/config/productsMenuConfig.ts`](../../src/app/config/productsMenuConfig.ts) |
...
| Design system | Theme tokens, generic ui files, active component inventory, template registry with 50 code-backed previews, centralized icon registry, centralized color registry, and Light/Dark smoke checks | no automated visual consistency, reconstructed-template, icon-registry, or color-token guard | component inventory, screenshot/code-template coverage, reconstructed-template coverage, icon registry audit, color-token audit, and Light/Dark visual snapshots | [`src/styles/theme.css`](../../src/styles/theme.css), [`src/app/components/ui`](../../src/app/components/ui), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/templates/TemplateCodePreviews.tsx`](../../src/app/components/templates/TemplateCodePreviews.tsx), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) |
