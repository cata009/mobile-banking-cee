...
| Mobile frame shell | Renders phone frame, status bar, dynamic island, overlays, glow, and bounded desktop auto-fit scaling | Creates a consistent device-like viewport without unwanted page-level desktop scroll | `implemented` | [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/StatusBar.tsx`](../../src/app/components/StatusBar.tsx), [`src/app/components/DynamicIsland.tsx`](../../src/app/components/DynamicIsland.tsx) |
...
| Function | Description | User value | Status | Evidence |
| --- | --- | --- | --- | --- |
| Payments menu | Shows the country-scoped Payments hub: default markets keep four primary payment actions and the original QR/template/card repayment/exchange-rate shortcut rail, while BA and BA_BL now show five primary cards plus Template, Card repayment, Standing Order, Foreign Payments, and Exchange Rate shortcuts; the New payment bottom sheet still opens Domestic payment and keeps other action rows placeholder-compatible | Gives the bottom-nav Payments tab a real stakeholder-demo surface while preserving Bosnia application differences | `implemented` | [`src/app/screens/payments/PaymentsScreen.tsx`](../../src/app/screens/payments/PaymentsScreen.tsx), [`src/app/components/payments/PaymentOtherShortcut.tsx`](../../src/app/components/payments/PaymentOtherShortcut.tsx), [`src/app/config/paymentsMenuConfig.ts`](../../src/app/config/paymentsMenuConfig.ts), [`src/app/components/BottomSheet.tsx`](../../src/app/components/BottomSheet.tsx), [`src/app/registry/screenRegistry.ts`](../../src/app/registry/screenRegistry.ts) |
...
| Navigation shell | Build + manual browser verification for mobile frame viewport fit, stable top-level header action slots across Home/Payments/Products/More, and Messages header routing | no route-state or visual viewport regression tests | state-machine tests for screen transitions, back stack, desktop viewport fit at multiple heights, top-header action-slot stability, and Messages entry/back navigation | [`src/app/contexts/NavigationContext.tsx`](../../src/app/contexts/NavigationContext.tsx), [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/HeaderActionIcons.tsx`](../../src/app/components/HeaderActionIcons.tsx), [`src/app/screens/messages/MessagesScreen.tsx`](../../src/app/screens/messages/MessagesScreen.tsx) |
