...
- Total verified capability areas: `17`
- Capability status counts:
  - `implemented`: 9
  - `partial`: 4
  - `mock-driven`: 3
  - `legacy/dormant`: 1
- Active page/state coverage mapped: `19/20` navigation states in the screen registry; `language-selector` remains a supporting component outside the registry
...
5. Mobile demo shell and design-system inventory are reusable foundations: the shell auto-fits inside the desktop viewport, while icons/colors/templates are centralized for AI reuse and future DS migration. Evidence: [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts).
...
2. No real transaction, payment execution, product-detail execution, analytics, or messages backend despite visible navigation affordances, the mock Analytics / My Spendings screen, and the mock Domestic payment sign/success flow. Evidence: [`src/app/components/BottomNavigation.tsx`](../../src/app/components/BottomNavigation.tsx), [`src/app/screens/home/HomeScreen.tsx`](../../src/app/screens/home/HomeScreen.tsx), [`src/app/screens/analytics/AnalyticsScreen.tsx`](../../src/app/screens/analytics/AnalyticsScreen.tsx), [`src/app/screens/payments/PaymentsScreen.tsx`](../../src/app/screens/payments/PaymentsScreen.tsx), [`src/app/screens/payments/DomesticPaymentFlowScreens.tsx`](../../src/app/screens/payments/DomesticPaymentFlowScreens.tsx), [`src/app/screens/products/ProductsScreen.tsx`](../../src/app/screens/products/ProductsScreen.tsx).
...
3. Core action: the user moves through pre-login, optional Co-Apping, home, account detail, transaction detail, Domestic payment create/review/sign/success, payments, products, prime, more, and contacts screens inside the mobile frame. Evidence: [`src/app/App.tsx`](../../src/app/App.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx).
...
- Country registry drives currencies, locale, language pair, More cards, Payments helper copy, Products tab availability, and Co-Apping availability. Evidence: [`src/app/registry/countryConfig.ts`](../../src/app/registry/countryConfig.ts), [`src/app/registry/languageByCountry.ts`](../../src/app/registry/languageByCountry.ts), [`src/app/config/moreCardsConfig.ts`](../../src/app/config/moreCardsConfig.ts), [`src/app/config/paymentsMenuConfig.ts`](../../src/app/config/paymentsMenuConfig.ts), [`src/app/config/productsMenuConfig.ts`](../../src/app/config/productsMenuConfig.ts), [`src/app/utils/coAppingAvailability.ts`](../../src/app/utils/coAppingAvailability.ts).
...
- Static data models feed the home summary, product accordions, transaction detail, and mock Domestic payment drafts. Evidence: [`src/data/products.ts`](../../src/data/products.ts), [`src/hooks/useProducts.tsx`](../../src/hooks/useProducts.tsx), [`src/app/config/productConfig.ts`](../../src/app/config/productConfig.ts), [`src/data/paymentFlow.ts`](../../src/data/paymentFlow.ts).
...
| Appearance selector | Switches the active demo between Light and Dark token themes | Lets stakeholders inspect current DS colors in both appearance modes without changing product/design-system context | `implemented` | [`src/app/components/demo/DemoTopBar.tsx`](../../src/app/components/demo/DemoTopBar.tsx), [`src/app/components/demo/DemoFeatureSidePanel.tsx`](../../src/app/components/demo/DemoFeatureSidePanel.tsx), [`src/app/state/demoStore.tsx`](../../src/app/state/demoStore.tsx), [`src/styles/theme.css`](../../src/styles/theme.css) |
...
| Function | Description | User value | Status | Evidence |
| --- | --- | --- | --- | --- |
| Screen-state navigation | Manages the 20 navigation states without URL routing | Simple deterministic demo flow | `implemented` | [`src/app/contexts/NavigationContext.tsx`](../../src/app/contexts/NavigationContext.tsx), [`src/app/App.tsx`](../../src/app/App.tsx) |
...
| Function | Description | User value | Status | Evidence |
| --- | --- | --- | --- | --- |
| Payments menu | Shows four primary payment actions, QR/template/card repayment/exchange-rate shortcuts, and a New payment bottom sheet where Domestic opens a flow and Foreign/SEPA plus Templates/Beneficiaries remain placeholders | Gives the bottom-nav Payments tab a real stakeholder-demo surface | `implemented` | [`src/app/screens/payments/PaymentsScreen.tsx`](../../src/app/screens/payments/PaymentsScreen.tsx), [`src/app/config/paymentsMenuConfig.ts`](../../src/app/config/paymentsMenuConfig.ts), [`src/app/components/BottomSheet.tsx`](../../src/app/components/BottomSheet.tsx), [`src/app/registry/screenRegistry.ts`](../../src/app/registry/screenRegistry.ts) |
...
| Products menu | Shows offers, banking products, other solutions, reusable 164x120 product cards, and country-scoped Banking/ShopSmart tabs for RO/CZ/SK/HU only | Gives the bottom-nav Products tab a real stakeholder-demo surface while preserving country differences | `implemented` | [`src/app/screens/products/ProductsScreen.tsx`](../../src/app/screens/products/ProductsScreen.tsx), [`src/app/components/products/ProductMenuCard.tsx`](../../src/app/components/products/ProductMenuCard.tsx), [`src/app/config/productsMenuConfig.ts`](../../src/app/config/productsMenuConfig.ts), [`src/app/registry/screenRegistry.ts`](../../src/app/registry/screenRegistry.ts) |
...
| Design-system inventory | `AI/DS foundation` | `implemented` | `medium` | `critical` | component/template/icon/color registries | [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) | No automated registry drift audits yet |
...
| Screenshot templates | `templateRegistry.ts` plus `screenshots/` assets | Design System Inventory `Templates` tab | static TS source files and image files | build plus folder/registry coverage check | `medium` | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`screenshots`](../../screenshots), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
| Design System templates | Template registry plus screenshot assets | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`screenshots`](../../screenshots) | AI/component reuse mapping can miss supplied references | [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
| Screenshot template catalog | `templateRegistry.ts` entries backed by files in `screenshots/` | `persistent source artifact` | no | no runtime export | git versioned | [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`screenshots`](../../screenshots), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
| UI color registry | `colorRegistry.ts` palette definitions plus `theme.css` semantic variables and Design System Inventory Colors tab | `persistent source artifact` | no | no runtime export | git versioned | [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts), [`src/styles/theme.css`](../../src/styles/theme.css), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx) |
...
5. Screenshot-backed template inventory for AI/component reuse review. Evidence: [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`screenshots`](../../screenshots).
...
| Navigation shell | Build + manual browser verification for mobile frame viewport fit and stable top-level header action slots across Home/Payments/Products/More | no route-state or visual viewport regression tests | state-machine tests for screen transitions, back stack, desktop viewport fit at multiple heights, and top-header action-slot stability | [`src/app/contexts/NavigationContext.tsx`](../../src/app/contexts/NavigationContext.tsx), [`src/app/components/demo/DemoShell.tsx`](../../src/app/components/demo/DemoShell.tsx), [`src/app/components/MobileFrame.tsx`](../../src/app/components/MobileFrame.tsx), [`src/app/components/HeaderActionIcons.tsx`](../../src/app/components/HeaderActionIcons.tsx) |
...
| Design system | Theme tokens, generic ui files, active component inventory, screenshot template registry, centralized icon registry, centralized color registry, and Light/Dark smoke checks | no automated visual consistency, icon-registry guard, or color-token guard | component inventory, screenshot-template coverage, icon registry audit, color-token audit, and Light/Dark visual snapshots | [`src/styles/theme.css`](../../src/styles/theme.css), [`src/app/components/ui`](../../src/app/components/ui), [`src/app/screens/design-system/DesignSystemPage.tsx`](../../src/app/screens/design-system/DesignSystemPage.tsx), [`src/app/registry/templateRegistry.ts`](../../src/app/registry/templateRegistry.ts), [`src/app/components/icons/AppIcon.tsx`](../../src/app/components/icons/AppIcon.tsx), [`src/app/registry/colorRegistry.ts`](../../src/app/registry/colorRegistry.ts) |
...
# passed: Templates tab selected, 30 selectable cards, selected preview image loads, Transaction detail selection updates preview to screenshots/Transaction detail.png
