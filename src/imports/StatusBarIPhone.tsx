import svgPaths from "./svg-2hn0mpby87";
...
export default function StatusBarIPhone() {
  return (
    <div className="content-stretch flex gap-[154px] items-center justify-center pb-[19px] pt-[21px] px-[24px] relative size-full" data-name="Status bar - iPhone">
      <Time />
      <Levels />
    </div>
  );
