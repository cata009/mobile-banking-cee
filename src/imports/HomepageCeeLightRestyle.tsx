import svgPaths from "./svg-9kve8oh80e";
...
import imgImage128 from "figma:asset/40072ac1587e0a070d3bd6c437a557892e0687a0.png";
import { imgRectangle, imgFrame1699, img1000F1351018953Xn3Y0KEfi9SZc6WqxoT6GApUlcapa1Qi1, imgGianCescon00ByExKcSkAUnsplash } from "./svg-ok011";
    ...
    <div className="relative shrink-0 size-[32px]" data-name="ic_navigation_homepage_restyle_analytics_grey">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="ic_navigation_homepage_restyle_analytics_grey">
          ...
          <mask height="20" id="mask0_1_8889" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="20" x="6" y="6">
            <path clipRule="evenodd" d={svgPaths.p654f280} fill="var(--fill-0, white)" fillRule="evenodd" id="Icon_2" />
          </mask>
          <g mask="url(#mask0_1_8889)" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="-translate-y-1/2 absolute h-[10px] left-0 top-[calc(50%-1.25px)] w-[35px]" data-name="Left Detail">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 10">
        <g clipPath="url(#clip0_1_8737)" id="Left Detail">
      ...
      <div className="absolute inset-[-0.64%_-0.31%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 329 159">
          <g id="Group 4">
            ...
            <mask height="157" id="mask0_1_8678" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="327" x="1" y="1">
              <path clipRule="evenodd" d={svgPaths.p2cbcfb00} fill="var(--fill-0, white)" fillRule="evenodd" id="Mask_2" />
            </mask>
            <g mask="url(#mask0_1_8678)">
              <g id="aempty">
                <g id="SafeArea24" />
                <g id="Rectangle" />
              </g>
...
function IconR() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon R">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon R">
          <path d={svgPaths.p19fccb00} fill="var(--fill-0, #262626)" id="Icon" />
          <g id="SafeArea24" />
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex items-start justify-between px-[24px] relative w-full">
        <p className="font-['UniCredit:Bold',sans-serif] leading-[normal] max-w-[287px] not-italic relative shrink-0 text-[#262626] text-[28px] w-[287px] whitespace-pre-wrap">Co-Apping Session</p>
        <IconR />
      </div>
    </div>
  );
...
function Frame64() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start leading-[normal] not-italic relative shrink-0 text-[18px] text-black w-full whitespace-pre-wrap">
      <p className="font-['UniCredit:Bold',sans-serif] relative shrink-0 w-full">{`You are about to have a co-apping session with your banker, where you'll share your mobile screen for assistance in completing your banking needs.`}</p>
      <p className="font-['UniCredit:Regular',sans-serif] relative shrink-0 w-full">To start the process, please enter the code provided by your banker over the phone and click continue.</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <div className="h-[160px] relative rounded-[8px] shrink-0 w-[327px]" data-name="image 128">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgImage128} />
      </div>
      <Frame62 />
    </div>
  );
...
function Frame48() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[327px]">
      <Frame63 />
    </div>
  );
}
...
function Frame41() {
  return (
    <div className="h-[40px] relative shrink-0 w-full">
      <p className="absolute font-['UniCredit:Regular',sans-serif] h-[22px] leading-[normal] left-0 not-italic text-[#262626] text-[18px] top-[18px] w-[295px] whitespace-pre-wrap">123434ABC</p>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col gap-[3px] h-[31px] items-start relative shrink-0 w-[295px]">
      <p className="font-['UniCredit:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#666] text-[14px] w-full whitespace-pre-wrap">Rest assured, your essential data will be protected and will not be shared with the banker.</p>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[38px] items-start relative shrink-0 w-full">
      <div className="h-[0.5px] relative shrink-0 w-[295px]" data-name="Divider">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 295 0.5">
          <path clipRule="evenodd" d="M0 0H295V0.5H0V0Z" fill="var(--fill-0, #262626)" fillRule="evenodd" id="Divider" />
        </svg>
      </div>
      <Frame37 />
    </div>
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[82px] items-start relative shrink-0 w-full">
      <Frame41 />
      <Frame38 />
    </div>
  );
...
function Frame40() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col h-[82px] items-start left-[24px] top-[calc(50%+1px)] w-[295px]">
      <Frame39 />
    </div>
  );
}
...
function TextField() {
  return (
    <div className="bg-white h-[96px] relative shrink-0 w-[375px]" data-name="Text field">
      <Frame40 />
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#007a91] content-stretch flex h-[48px] items-center justify-center py-[12px] relative rounded-[4px] shrink-0 w-[327px]" data-name="Button">
...
function Frame43() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[24px] h-[786px] items-start left-0 pt-[24px] w-[375px]">
      <div className="absolute bg-white inset-0 rounded-tl-[12px] rounded-tr-[12px]" data-name="Rectangle3" />
      <Frame65 />
    </div>
  );
}

function LightRestylePanel() {
  return (
    <div className="absolute h-[812px] left-0 top-0 w-[375px]" data-name="Light Restyle / Panel">
