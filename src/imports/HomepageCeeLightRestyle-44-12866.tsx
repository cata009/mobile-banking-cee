import svgPaths from "./svg-41de24z6bt";
...
import { imgRectangle, imgFrame1699 } from "./svg-6t41q";

function NavigationAndActionShareScreenK() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[24px] top-1/2" data-name="Navigation and action/Share screen_K10">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Navigation and action/Share screen_K10">
          <path clipRule="evenodd" d={svgPaths.p34f15300} fill="var(--fill-0, white)" fillRule="evenodd" id="Path" />
        </g>
      </svg>
    </div>
  );
...
function Icon() {
  return (
    <div className="absolute inset-[36.28%_4.55%_35.4%_22.73%] overflow-clip" data-name="Icon">
      <NavigationAndActionShareScreenK />
    </div>
  );
}
...
function Patch() {
  return (
    <div className="absolute h-[113.004px] right-0 top-[432px] w-[44px]" data-name="Patch">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 113.013">
        <path d={svgPaths.p2d5f5a80} fill="var(--fill-0, #008574)" id="Subtract" />
      </svg>
      <Icon />
    </div>
  );
