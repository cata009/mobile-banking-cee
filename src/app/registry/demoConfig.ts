...
export const FEATURE_META: Record<FeatureId, FeatureMeta> = {
  ...
  fx_app2027Homepage: {
    ...
    description: "Global App 2027 preview of the Mobile PI Homepage.",
    kind: "release",
    scope: "global",
  ...
  fx_evo2027Homepage: {
    ...
    description: "Czech-only Evo 2027 preview of the Mobile PI Homepage, initially matching App 2027.",
    kind: "release",
    scope: "countries",
    countries: ["CZ"],
