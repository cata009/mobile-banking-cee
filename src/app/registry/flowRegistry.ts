...
export const FLOW_REGISTRY: Record<FlowId, FlowMeta> = {
  ...
  "pi.home-to-products-menu": {
    ...
    steps: [
      ...
      { screenId: "pi.products.detail", intent: "Open a product-category bottom sheet option, then view the selected product detail page with the row title and mapped illustration." },
    ],
    requiredFeatures: [],
    optionalFeatures: [],
    evidence: ["src/app/App.tsx", "src/app/screens/products/ProductsScreen.tsx", "src/app/screens/products/ProductDetailScreen.tsx", "src/app/config/productsMenuConfig.ts"],
  },
  ...
  "kids.market-home-bottom-nav": {
    ...
    steps: [
      { screenId: "kids.sk.home-concept", intent: "Open Mobile PI Kids in Slovakia and review the Bulbank document-inspired Kids concept with Products home, Education, Tasks, and More bottom navigation." },
      ...
      { screenId: "kids.rs.home-concept", intent: "Switch to Serbia and review the Teens (12-18) concept with payments-with-approval and the Uči educational coach, raised centre Plaćanja nav." },
    ],
    requiredFeatures: [],
    optionalFeatures: [],
