...
export const FLOW_REGISTRY: Record<FlowId, FlowMeta> = {
  ...
  "kids.market-home-bottom-nav": {
    ...
    steps: [
      ...
      { screenId: "kids.rs.home-concept", intent: "Switch to Serbia and review the safe-spend coach homepage with today guidance, goal spotlight, earn-next tasks, card safety, and shared PI bottom navigation." },
    ],
    requiredFeatures: [],
    optionalFeatures: [],
