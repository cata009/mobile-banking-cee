...
export const TEMPLATE_REGISTRY: readonly TemplateRegistryItem[] = [
  ...
  defineTemplate({
    ...
    format: "png",
    screenFamily: "products",
    runtimeScreenId: "pi.products.detail",
    relatedScreens: ["pi.products.detail", "pi.products.overview", "platform.design-system"],
    flowIds: ["pi.home-to-products-menu"],
    relatedComponents: ["shell.page-header", "products.menu", "ui.primary-button", "icons.app-icon", "templates.reconstructed-code"],
    codePreviewId: "product-detail",
    implementationPath: "src/app/screens/products/ProductDetailScreen.tsx",
    implementationStatus: "reconstructed-code",
    reuseNotes: [
      "Reconstructs the Product template as a Level 1 page using the shared PageHeader, Figma-sourced 327x160 product illustration, body copy, and reusable PrimaryButton.",
      "Products bottom-sheet rows open this runtime detail page and pass the selected row title, while images are mapped from the Meniga Harmonization Icons Pictures section.",
    ],
  }),
  defineTemplate({
