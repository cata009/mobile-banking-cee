...
export const SCREEN_REGISTRY: Record<ScreenId, ScreenMeta> = {
  ...
  "pi.language.selector": {
    id: "pi.language.selector",
    label: "PI language selector",
    runtimeScreen: "language-selector",
    products: ["PI"],
    countries: ALL_COUNTRIES,
    designSystems: ["current"],
    status: "partial",
    ...
    features: [], screenshots: [], similarTo: ["pi.prelogin.active"],
  },
  "pi.home.overview": {
    id: "pi.home.overview",
  ...
  "pi.transactions.overview": {
    id: "pi.transactions.overview",
    label: "PI Transactions",
    runtimeScreen: "transactions",
    products: ["PI"],
    countries: ALL_COUNTRIES,
    designSystems: ["current"],
    status: "mock-driven",
    layoutFamily: "account-detail",
    componentPath: "src/app/screens/accounts/TransactionsScreen.tsx",
    features: [],
    screenshots: [],
  ...
  "pi.my-banker.recommendations": {
    id: "pi.my-banker.recommendations",
    label: "PI My Banker recommendations",
    runtimeScreen: "my-banker",
    products: ["PI"],
    countries: ["RS"],
    designSystems: ["current"],
    status: "mock-driven",
    layoutFamily: "products",
    componentPath: "src/app/screens/my-banker/MyBankerScreen.tsx",
    features: ["fx_rsMyBanker"],
    screenshots: [],
    similarTo: ["pi.products.overview", "pi.products.detail"],
  },
  "pi.products.detail": {
  ...
  "pi.investments.history": {
    ...
    products: ["PI"], countries: ALL_COUNTRIES, designSystems: ["current"], status: "mock-driven",
    layoutFamily: "investments", componentPath: "src/app/screens/investments/InvestmentsHistoryScreen.tsx",
    features: [], screenshots: [], similarTo: ["pi.investments.portfolio"],
  },
  "pi.card.detail": {
    id: "pi.card.detail", label: "PI Card detail", runtimeScreen: "card-detail",
    products: ["PI"], countries: ALL_COUNTRIES, designSystems: ["current"], status: "partial",
    layoutFamily: "account-detail", componentPath: "src/app/screens/cards/CardDetailScreen.tsx",
    features: [], screenshots: [], similarTo: ["pi.card.details-info", "pi.card.options"],
  },
  "pi.card.details-info": {
    id: "pi.card.details-info", label: "PI Card details info", runtimeScreen: "card-details-info",
    products: ["PI"], countries: ALL_COUNTRIES, designSystems: ["current"], status: "partial",
    layoutFamily: "account-detail", componentPath: "src/app/screens/cards/CardDetailsInfoScreen.tsx",
    features: [], screenshots: [], similarTo: ["pi.card.detail", "pi.card.options"],
  },
  "pi.card.options": {
    id: "pi.card.options", label: "PI Card options", runtimeScreen: "card-options",
    products: ["PI"], countries: ALL_COUNTRIES, designSystems: ["current"], status: "partial",
    layoutFamily: "account-options", componentPath: "src/app/screens/cards/CardOptionsScreen.tsx",
    features: [], screenshots: [], similarTo: ["pi.card.detail", "pi.card.details-info"],
  },
  "pi.prime.overview": {
