...
export const COMPONENT_REGISTRY: Record<ComponentId, ComponentMeta> = {
  ...
  "ui.section-heading-divider": {
    ...
    usedByScreens: ["pi.analytics.overview", "pi.payment.domestic-create", "pi.investments.portfolio", "pi.settings.overview", "pi.contacts.overview", "kids.hu.home-concept", "kids.rs.home-concept", "platform.design-system"],
