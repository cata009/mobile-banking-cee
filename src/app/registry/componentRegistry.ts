...
export const COMPONENT_REGISTRY: Record<ComponentId, ComponentMeta> = {
  ...
  "shell.status-bar": {
    ...
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/StatusBar.tsx",
    usedByScreens: [
      "pi.prelogin.inactive",
      "pi.prelogin.active",
      "pi.co-apping.session",
    ...
    notes: "Absolute, pointer-events-none overlay rendering the simulated iOS clock plus cellular/wifi/battery glyphs at the top of the phone frame. Foreground color follows the light/dark/theme variant and Co-Apping active tone.",
  },
  "shell.home-header": {
    id: "shell.home-header",
    label: "Home header",
    products: ["PI"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/screens/home/HomeHeader.tsx",
    usedByScreens: ["pi.home.overview"],
    notes: "Home screen top bar with the UniCredit mark, Prime entry, and Messages icon with unread badge.",
  },
  "shell.more-header": {
    id: "shell.more-header",
    label: "More header",
    products: ["PI"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/screens/more/MoreHeader.tsx",
    usedByScreens: ["pi.more.overview"],
    notes: "More screen top bar with profile initials avatar, Messages icon with unread count, and Logout action.",
  },
  "icons.app-icon": {
    id: "icons.app-icon",
  ...
  "ui.language-selector-button": {
    id: "ui.language-selector-button",
    label: "Language selector button",
    products: ["PI"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/ui/LanguageSelectorButton.tsx",
    usedByScreens: ["pi.prelogin.inactive", "pi.prelogin.active", "platform.design-system"],
    notes: "Compact top-bar language toggle: right-aligned uppercase language code over a 1px underline, used on pre-login surfaces.",
  },
  "ui.navigation-link": {
    id: "ui.navigation-link",
    label: "Navigation link",
    products: ["PI"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/ui/NavigationLink.tsx",
    usedByScreens: ["pi.prelogin.inactive", "pi.prelogin.active", "platform.design-system"],
    notes: "Dark-surface text link with a trailing chevron icon, used for pre-login find-out-more actions.",
  },
  "ui.prelogin-heading": {
    id: "ui.prelogin-heading",
    label: "Prelogin heading",
    products: ["PI"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/ui/PreLoginHeading.tsx",
    usedByScreens: ["pi.prelogin.inactive", "pi.prelogin.active", "platform.design-system"],
    notes: "Three-line white pre-login hero heading (38px bold H1, 24px bold H2, 18px regular H3) stacked with a 16px group gap and a 32px gap between H1 and H2.",
  },
  "ui.button-registry": {
    id: "ui.button-registry",
    label: "Button registry variants",
    products: ["PI", "SME"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/ui/button.tsx",
    usedByScreens: ["platform.design-system"],
    notes: "Vendored shadcn/Radix Button primitive exposing default, secondary, outline, ghost, and destructive variants for generic (non-branded) call-to-action use, separate from the bespoke PrimaryButton.",
  },
  "ui.generic-controls": {
    id: "ui.generic-controls",
    label: "Generic UI controls",
    products: ["PI", "SME"],
    designSystems: ["current"],
    status: "implemented",
    componentPath: "src/app/components/ui/button.tsx + badge.tsx + input.tsx + checkbox.tsx + toggle.tsx + toggle-group.tsx + slider.tsx + progress.tsx + separator.tsx + skeleton.tsx + alert.tsx + tabs.tsx",
    usedByScreens: ["platform.design-system"],
    notes: "Vendored shadcn/Radix primitive family (Button, Badge, Input, Checkbox, Toggle, Toggle group, Slider, Progress, Separator, Skeleton, Alert, Tabs) kept generic and separate from bespoke UniCredit components.",
  },
  "prelogin.inactive": {
  ...
  "prelogin.other-panel-basic": {
    ...
    usedByScreens: ["pi.prelogin.inactive"],
    notes: "Pre-login panel variant for countries where Co-Apping is unavailable: Smart Banking, exchange rates, and ATM/branches rows only, without the Co-Apping entry row.",
  },
  ...
  "transactions.party-avatar": {
    ...
    notes: "Counterparty initials on a tint derived deterministically from the name, with a corner badge carrying the direction: an arrow for money sent, a plus for money received.",
  },
  "transactions.pair-avatar": {
    ...
    usedByScreens: ["pi.account.detail", "pi.transaction.detail"],
    notes: "Two overlapping roundels for a movement between the customer's own money — payer behind, destination in front. Accounts show a product glyph, currency exchanges show the two flags.",
  },
  ...
  "accounts.carousel-indicator": {
    ...
    notes: "32px-tall dot rail for the account/product carousel: up to 4 items render as individual dots, more than 4 collapses to a sliding 5-dot window with 4px mini dots at either end. Active dot is a 30x6 rounded rectangle; inactive dots are 6x6.",
  },
