...
export const COMPONENT_REGISTRY: Record<ComponentId, ComponentMeta> = {
  ...
  "shell.bottom-sheet": {
    ...
    notes: "Reusable overlay and rounded bottom panel shell for modal quick menus.",
  },
  "prelogin.inactive": {
  ...
  "analytics.spendings": {
    ...
    notes: "Screenshot-inspired My Spendings screen with static inflow/spending bars, cash transaction banner, and Money Out summary.",
  },
  ...
  "accounts.transaction-search": {
    ...
    usedByScreens: ["pi.account.detail"],
    notes: "Searches the current account transaction list, swaps the filter icon for a clear-results action while a query is active, and keeps the search bar pinned at the top of the list.",
  },
  ...
  "transactions.detail": {
    ...
    notes: "Shows transaction amount, category actions, spending insight, details, and a Redo payment entry into domestic payment.",
  },
  "payments.menu": {
    id: "payments.menu",
    label: "Payments menu",
  ...
  "payments.other-shortcut": {
    ...
    usedByScreens: ["pi.payments.overview"],
    notes: "Reusable single shortcut action used in Payments OTHER, with a 32x32 icon slot and UniCredit 14px bold label styling.",
  },
  ...
  "payments.new-payment-discover-banner": {
    ...
    usedByScreens: ["pi.payments.overview"],
    notes: "Reusable teal help banner for New payment with supplied info and close icons.",
  },
  ...
  "products.offer-card": {
    ...
    usedByScreens: ["pi.products.overview"],
    notes: "Reusable 327x157 offer carousel card with 206px text stack, 24px bold title, and 16px regular subtitle.",
  },
