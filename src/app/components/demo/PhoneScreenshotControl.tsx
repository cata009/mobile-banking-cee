    ...
    <div className="relative" data-phone-screenshot-control="true">
      <DropdownMenu>
        ...
        <DropdownMenuContent
          ...
          sideOffset={8}
        >
          <PhoneScreenshotMenuItems disabled={disabled} getScreenElement={getScreenElement} />
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
  );
...
export function PhoneScreenshotMenuItems({
  disabled = false,
  getScreenElement = getDefaultPhoneScreenElement,
  itemClassName,
  ...
  const menuItemClassName =
    itemClassName ??
    "cursor-pointer rounded-[4px] px-3 py-2 font-['UniCredit',sans-serif] text-[14px] font-bold text-[var(--uc-text)] focus:bg-[var(--uc-surface-muted)] focus:text-[var(--uc-text)]";
