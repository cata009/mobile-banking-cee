...
type CustomIconDefinition = BaseIconDefinition & {
  source: "custom";
  viewBox: string;
  width: number;
  height: number;
...
type LucideIconDefinition = BaseIconDefinition & {
  source: "lucide";
...
const CUSTOM_ICONS = {
  ...
  search: {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.6751 13.5921C19.6751 16.3828 17.4006 18.6534 14.6051 18.6534C11.8097 18.6534 9.53524 16.3828 9.53524 13.5921C9.53524 10.8013 11.8097 8.53069 14.6051 8.53069C17.4006 8.53069 19.6751 10.8013 19.6751 13.5921ZM22.2098 13.5921C22.2098 9.39934 18.8046 6 14.6049 6C10.4051 6 7 9.39934 7 13.5921C7 17.7848 10.4051 21.1841 14.6049 21.1841C16.0631 21.1841 17.4199 20.7671 18.5771 20.0567L24.5971 26C25.8962 24.703 25.8962 22.5994 24.5971 21.3024L20.9917 17.7038C21.7591 16.5181 22.2098 15.1086 22.2098 13.5921ZM16.5064 13.5921C16.5064 12.5437 15.6553 11.694 14.6051 11.694C13.555 11.694 12.7039 12.5437 12.7039 13.5921C12.7039 14.6404 13.555 15.4901 14.6051 15.4901C15.6553 15.4901 16.5064 14.6404 16.5064 13.5921Z"
        fill="currentColor"
      />
    ),
  },
  filters: {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.80974 6.5C9.87052 6.50579 10.8371 7.09886 11.3073 8.03237H25.9803V10.4842H11.326C10.8725 11.3814 9.95999 11.9677 8.94086 12.0165H8.80974C7.25796 12.0165 6 10.7816 6 9.25827C6 7.73492 7.25796 6.5 8.80974 6.5ZM23.1706 13.2424C24.5589 13.233 25.7461 14.2204 25.9647 15.5663C26.1833 16.9121 25.3678 18.213 24.0454 18.6279C22.723 19.0429 21.2901 18.4474 20.6731 17.2266H6V14.7748H20.6543C21.1275 13.8354 22.1031 13.2413 23.1706 13.2424ZM16.9267 21.5172C16.4566 20.5837 15.49 19.9906 14.4292 19.9849H14.2981C13.2785 20.0324 12.3654 20.619 11.9129 21.5172H6V23.969H11.9129C12.3876 24.9069 13.3624 25.5 14.4292 25.5C15.496 25.5 16.4708 24.9069 16.9455 23.969H25.9803V21.5172H16.9267Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "new-payment-domestic": {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.12475 3.125C8.12475 4.85063 6.726 6.25 4.99972 6.25C3.27408 6.25 1.8747 4.85063 1.8747 3.125C1.8747 1.39875 3.27408 0 4.99972 0C6.726 0 8.12475 1.39875 8.12475 3.125ZM18.4734 4.41856C18.4734 5.82356 17.3347 6.96231 15.9297 6.96231C14.5247 6.96231 13.3859 5.82356 13.3859 4.41856C13.3859 3.01356 14.5247 1.87481 15.9297 1.87481C17.3347 1.87481 18.4734 3.01356 18.4734 4.41856ZM0.625631 7.5H0V20H9.56506V16.4394C9.56506 11.5019 5.56254 7.5 0.625631 7.5ZM11.8749 15.0612C11.8749 11.5131 14.7512 8.63619 18.3 8.63619H18.75V17.7231H11.8749V15.0612Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "panel-share-screen": {
    ...
    render: () => (
      <path
        clipRule="evenodd"
        fillRule="evenodd"
        d="M14.9286 10.2134V11.8977L8.5176 11.8977V21.4427H23.1393V18.7476H24.8264V22.0041C24.8264 23.1948 23.8982 24.1692 22.7248 24.2452L22.5769 24.25H6.83048V12.4592C6.83048 11.268 7.75873 10.2941 8.93208 10.2181L9.07997 10.2134H14.9286ZM25.1638 8.41667V16.8386C23.9007 16.8386 22.8766 15.8162 22.8766 14.5557V12.3143L18.3456 16.8386L16.7282 15.2239L21.2598 10.6996H19.0154C17.7523 10.6996 16.7282 9.67771 16.7282 8.41667L25.1638 8.41667Z"
        fill="currentColor"
      />
    ),
  },
  "prime-check": {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M20.847 11.0925C22.2483 9.63583 24.5196 9.63583 25.921 11.0925L14.4528 23L6.07886 14.311C7.47959 12.855 9.75151 12.855 11.1529 14.311L14.4528 17.7251L20.847 11.0925Z"
        fill="currentColor"
      />
    ),
  },
  "prime-direction": {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18.0141 19.5769C17.3866 18.9494 17.3866 17.9313 18.0141 17.3038L18.6929 16.625H15.6873C14.826 16.625 14.1248 17.3256 14.1248 18.1875V20.3751H12.2498V18.1875C12.2498 16.2925 13.7923 14.75 15.6873 14.75H18.6929L18.0141 14.0712C17.3866 13.4437 17.3866 12.4262 18.0141 11.7981L21.9041 15.6875L18.0141 19.5769ZM25.4422 14.6544L17.3466 6.55735C16.6029 5.81422 15.3973 5.81422 14.6542 6.55735L6.55734 14.6544C5.81422 15.3975 5.81422 16.6031 6.55734 17.3469L14.6542 25.4426C15.3973 26.1858 16.6029 26.1858 17.3466 25.4426L25.4422 17.3469C26.1859 16.6031 26.1859 15.3975 25.4422 14.6544Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "account-option-statement": {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.5944 6H8V22.875C8 24.6009 9.39911 26 11.125 26H23.625V10.0312L19.5944 6ZM11.125 19.125H20.5V17.875H11.125V19.125ZM20.5 22.25H11.125V21H20.5V22.25ZM11.125 16H16.125V14.75H11.125V16ZM18.625 7.25V11H22.375L18.625 7.25Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "account-option-change-name": {
    ...
    render: () => (
      <path
        d="M24.1367 11.6553C25.1886 11.8046 25.9999 12.6993 26 13.791V26H11.2949C10.1975 25.9998 9.30008 25.1817 9.15625 24.125H24.1367V11.6553ZM12.2539 8.5H20.7051C21.902 8.5 22.8729 9.46987 22.873 10.666V22.875H8.16797C6.97046 22.8748 6 21.9048 6 20.708V6H10.7949L12.2539 8.5ZM14.4375 11C11.8487 11 9.75 13.098 9.75 15.6875C9.75 18.2763 11.8487 20.375 14.4375 20.375C17.0263 20.375 19.125 18.2763 19.125 15.6875C19.125 13.098 17.0263 11 14.4375 11ZM17.0547 18.29H11.7812C11.8062 17.0223 12.8402 16.0068 14.1084 16.0049H17.0547V18.29ZM14.2188 12.665C14.9467 12.665 15.537 13.2554 15.5371 13.9834C15.5371 14.7115 14.9468 15.3018 14.2188 15.3018C13.4907 15.3018 12.9004 14.7115 12.9004 13.9834C12.9005 13.2554 13.4908 12.665 14.2188 12.665Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "user-event-refresh": {
    ...
    render: () => (
      <path
        d="M24 0V7.6084C23.2523 7.6084 21.8939 6.77867 21.8936 5.66211L21.9072 3.94531L12.5312 13.6484L8.83008 9.85059L3.56445 15.2734C4.79351 16.9281 6.75956 17.9999 8.97559 18C12.4773 18 15.355 15.3232 15.6865 11.8994L17.8105 9.70117C17.8975 10.2059 17.9521 10.7213 17.9521 11.25C17.9521 12.843 17.5353 14.3373 16.8115 15.6348C16.8093 15.6391 16.8075 15.644 16.8047 15.6484L20.4668 19.3379C21.7155 20.5994 21.5464 22.8098 20.3682 24L14.6611 18.2529C13.156 19.5001 11.2428 20.2499 9.15723 20.25L9.17676 20.2402C9.10934 20.2417 9.04375 20.25 8.97559 20.25C4.01828 20.2498 0 16.2208 0 11.25C2.17182e-05 6.27992 4.01829 2.25022 8.97559 2.25C11.7318 2.25 14.1955 3.49777 15.8418 5.45898L14.2764 7.06738C13.0419 5.49239 11.1288 4.47656 8.97559 4.47656C5.25128 4.47679 2.23242 7.50441 2.23242 11.2393C2.23249 12.1937 2.43123 13.1015 2.78711 13.9248C2.67241 13.6555 2.57362 13.3775 2.49414 13.0918L2.49707 13.0938L8.83008 6.58105L12.5312 10.3652L20.4287 2.25098L18.6836 2.24512C17.5963 2.24474 16.8301 0.749904 16.8301 0H24Z"
        fill="currentColor"
      />
    ),
  },
  ...
  "contact-location": {
    ...
    render: () => (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.375 13.5019C13.375 11.7756 14.7739 10.3762 16.4997 10.3762C18.2261 10.3762 19.625 11.7756 19.625 13.5019C19.625 15.2281 18.2261 16.6275 16.4997 16.6275C14.7739 16.6275 13.375 15.2281 13.375 13.5019ZM22.3068 18.2494C23.3652 16.9563 24 15.3037 24 13.5019C24 9.35875 20.6423 6 16.4997 6C12.3578 6 9 9.35875 9 13.5019C9 15.2587 9.60483 16.8725 10.6158 18.1512L16.4953 26L22.3068 18.2494Z"
        fill="currentColor"
      />
    ),
  },
    ...
    render: () => (
      <g transform="translate(6, 6)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M11.25 10.6055H7.265C6.3025 10.6055 5.5225 10 5.5225 8.78906H9.375V5.06604C9.375 4.13422 10 3.37859 11.25 3.37859V10.6055ZM10 0.3125C4.4775 0.3125 0 4.65008 0 10C0 15.3505 4.4775 19.6875 10 19.6875C15.5231 19.6875 20 15.3505 20 10C20 4.65008 15.5231 0.3125 10 0.3125Z"
          fill="currentColor"
        />
      </g>
    ),
    ...
    render: () => (
      <g transform="translate(6, 7)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M18.1252 8.75C18.1252 9.18937 18.044 9.60812 17.9052 10H2.09473C1.95536 9.60875 1.87536 9.18937 1.87536 8.75V0H18.1252V8.75ZM7.50006 13.75L6.25006 16.25H13.7501L12.5001 13.75H7.50006ZM17.9581 11.25L19.8181 15.7625C20.2356 16.7188 19.9094 17.5 19.095 17.5H0.905113C0.0901164 17.5 -0.235507 16.7188 0.181991 15.7625L2.01073 11.25H17.9581Z"
          fill="currentColor"
        />
      </g>
    ),
