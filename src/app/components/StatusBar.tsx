...
function Time({ variant }: { variant: PhoneChromeVariant }) {
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[22px] items-center justify-center min-h-px min-w-px relative" data-name="Time">
      <p 
  ...
  return (
    <div className="flex-[1_0_0] h-[22px] min-h-px min-w-px relative" data-name="Levels">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[7px] items-center justify-center pr-px relative size-full">
...
export default function StatusBar({ variant = 'dark' }: StatusBarProps) {
  return (
    <div className="absolute top-0 left-0 right-0 z-50 pointer-events-none">
      <div className="content-stretch flex gap-[154px] items-center justify-center pb-[16px] pt-[14px] px-[24px] relative w-full" data-name="Status bar - iPhone">
