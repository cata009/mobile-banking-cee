...
export function PrimeLabelValue({ label, value }: PrimeLabelValueProps) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[normal] min-h-px min-w-px not-italic py-[8px] relative text-[16px] text-[var(--uc-static-white)] whitespace-pre-wrap">
