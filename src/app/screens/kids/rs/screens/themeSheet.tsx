/**
 * RS Teens theme picker — a compact bottom sheet over the shared HU theme engine.
...
export function RsThemeSheet({
  ...
  return (
    <BottomSheet title="Promeni izgled" onClose={onClose}>
      <p className="mb-[14px] text-[14px] leading-[18px] text-[var(--uc-text-muted)]">
        Izaberi temu. Primenjuje se odmah — možeš da promeniš bilo kad.
      </p>
