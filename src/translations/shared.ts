...
const EN_RUNTIME: RuntimeTranslations = {
  ...
  accounts: {
    ...
    detailsInfo: {
      ...
      termDeposit: {
        ...
        interestAmountBeforeTax: "Interest amount before tax",
        ...
        interestRatePerYear: "Interest rate/year",
        currentAccountNumber: "Current account number",
        decreaseAmountBy: "Decrease amount by",
        reinvestInterest: "Reinvest the interest",
      },
      loan: {
  ...
  analytics: {
    ...
    addTransaction: "Add Transaction",
      ...
      filterOutSubcategory: "Filter out subcategory",
      includeSubcategory: "Include subcategory",
      openCategoryDetails: "Open category details",
    uncategorizedTransaction: "Uncategorized transaction",
    uncategorizedTransactionDescription: "Choose a category for this transaction and the app will remember it in the future.",
    dismissUncategorizedTip: "Dismiss uncategorized transaction tip",
  ...
  payments: {
    ...
    templates: {
      ...
      chooseBeneficiary: "OR CHOOSE A BENEFICIARY",
    ...
    exchangeRates: {
      ...
      chooseCurrencyAndAmount: "CHOOSE CURRENCY AND AMOUNT",
      amount: "Amount",
      currency: "Currency",
      tapForRates: "TAP FOR BUY/SELL RATES",
      chooseCurrency: "Choose currency",
      selectFromList: "SELECT FROM THE LIST BELOW",
      apply: "OK",
      closeChooser: "Close currency chooser",
  ...
  productsMenu: {
    ...
    shoppingBenefits: "Save when you shop",
