...
/**
 * English translations for Romania (RO)
...
const en: TranslationKeys = {
  ...
  products: {
    ...
    account: {
      ...
      description: 'Because we know how important time is, get your current accounts in LEI and/or Euro with a debit card and Mobile Banking attached.',
    },
    loans: {
      title: 'Loans',
